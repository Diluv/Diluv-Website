    ...
    <nav className={"flex items-center justify-between flex-wrap bg-diluv-800 px-4 py-1 font-hero"}>
      ...
      <div className={"w-full block flex-grow md:flex md:items-center md:w-auto" + (showMenu ? "" : " hidden")}>
        <div className="text-sm md:flex-grow">
          <Link href={"/"}><a
            className="block mt-4 md:inline-block md:mt-0 text-teal-200 hover:text-white mr-4 cursor-pointer transition-colors duration-150 ease-in">Home</a></Link>
          <Link href={"/games"}><a
            className="block mt-4 md:inline-block md:mt-0 text-teal-200 hover:text-white mr-4 cursor-pointer transition-colors duration-150 ease-in">Games</a></Link>
          <Link href={"/news"}><a
            className="block mt-4 md:inline-block md:mt-0 text-teal-200 hover:text-white mr-4 cursor-pointer transition-colors duration-150 ease-in">News</a></Link>
        </div>
