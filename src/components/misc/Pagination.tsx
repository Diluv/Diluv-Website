...
export default function Pagination({ maxPage, page, asBuilder, hrefBuilder }: { maxPage: number, page: number, asBuilder: (pageIndex: number) => {}, hrefBuilder: (pageIndex: number) => {} }) {
    return <>
        <ReactPaginate
