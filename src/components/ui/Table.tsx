...
export function Table({ children }: { children: ReactNode }) {
    return <table className={`table-auto w-full border dark:border-dark-700 cursor-default`}>
        {children}
    </table>;
}
...
export function TableRow({ children }: { children: ReactNode }) {
    return <tr className={`odd:bg-white even:bg-diluv-100 dark-odd:bg-dark-850 dark-even:bg-dark-800`}>
        {children}
    </tr>;
}
